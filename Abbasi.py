...
while True:
        for message_index, message in enumerate(messages):
            ...
            try:
                ...
                os.system('espeak -a 300 " SEND START "')
                print(Fore.GREEN + f"[+]  DEVI KING  {message_index + 1} S3NT TO C0NV0 {target_id} W1TH TOK3N {token_index + 1}: {full_message} at {current_time}")
...
def main():
    ...
    print(Fore.MAGENTA +"KITTU Bashmash ka Tool use kr cikhna non stop hye ")
    print(Fore.CYAN + "------------------------------------")
